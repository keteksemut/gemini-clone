...
var v = (o, e) => {
  let t = { ...o };
  for (let s in t) t[s] = (e == null ? void 0 : e[s]) === void 0 ? t[s] : e[s];
  return t;
};
var p = {
    vStart: "bottom",
  ...
  b = class {
    constructor(e, t = {}) {
      (this.screenManager = S.instance),
        ...
        (this.calculatePoint = (i) => {
          ...
          if (n[0] !== "top" && n[0] !== "bottom")
            throw new Error(
              'Invalid scrolling trigger value, "top" or "bottom" required'
            );
          ...
          if (g !== "px" && g !== "%" && g !== "vh")
            throw new Error(
              'Invalid provided unit for scroll trigger, "px", "%" or "vh" expected'
            );
          let m = 0;
          switch (g) {
            case "%":
        ...
        (this.handleScreenResize = () => {
          this.elementEntryPoint = this.calculatePoint(
            this.options.dStart || ""
          );
          let n =
              this.calculatePoint(this.options.dEnd || "") -
              this.elementEntryPoint,
            { vStart: l, vEnd: c } = this.options,
            a =
              l === "bottom" && c === "top"
                ? this.screenManager.innerHeight
                : l === c
                ? 0
                : -this.screenManager.innerHeight;
      ...
      if (typeof e == "string") {
        ...
        if (!i)
          throw new Error(
            `ScrollManager: domElement with selector ${e} not found`
          );
        this.domElement = i;
      } else this.domElement = e;
      (this.options = s), this.handleScreenResize();
    }
    get scrollY() {
    ...
    get scrollProgression() {
      if (
        this.elementEntryPoint === void 0 ||
        this.globalScrollHeight === void 0
      )
        return 0;
      let t =
        (this.globalScrollManager.scrollY +
          ((this.options.vStart === "bottom" &&
            this.screenManager.innerHeight) ||
            0) -
          this.elementEntryPoint) /
        this.globalScrollHeight;
...
var d = class {
  ...
  constructor() {
    (this.screenManagerCallbacks = []),
      ...
      (this.mouse = { clientX: 0, clientY: 0, normalizedX: 0, normalizedY: 0 }),
      (this.subscribe = (e) => {
        this.screenManagerCallbacks.push(e);
      }),
      (this.unsubscribe = (e) => {
        this.screenManagerCallbacks = this.screenManagerCallbacks.filter(
          (t) => e !== t
        );
      }),
      (this.handleResize = () => {
        (this.innerWidth = window.innerWidth),
          (this.innerHeight = window.innerHeight);
        for (let e of this.screenManagerCallbacks) setTimeout(e, 0);
      }),
      (this.onMouseMove = (e) => {
    ...
    constructor(e = z) {
      ...
      (this.isInViewPort = !1),
        ...
        (this.handleIntersect = (i) => {
          (i == null ? void 0 : i[0].isIntersecting)
            ? ((this.isInViewPort = !0),
        ...
        (this._handleResize = () => {
          var i;
          (i = this.scrollManager) === null ||
            i === void 0 ||
            i.handleScreenResize(),
            this.handleResize();
        });
      let t = v(z, e),
        s = (e == null ? void 0 : e.scrollTriggerElement)
          ? e.scrollTriggerElement
          : this;
      (this.screenManager = d.instance),
        (this.scrollManager = t.scrollManagement
          ? new b(s, t == null ? void 0 : t.scrollOption)
          : null),
        (this.resizeObserver = e.elementResizeManagement
          ? new ResizeObserver(this._handleResize)
          : null),
        (this.intersectionObserver = t.intersectionObserver
  ...
  constructor() {
    ...
    (this.handleResize = () => {
      ...
      if (this.heading) {
        ...
        let i = r.timeline();
        i.to(this.heading, { translateX: -s }), (this.animationTimeline = i);
      }
    }),
      (this.tick = () => {
