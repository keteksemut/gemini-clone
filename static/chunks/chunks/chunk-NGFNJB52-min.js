...
var p = {
  ...
  b = class {
    constructor(e, r = {}) {
      ...
      (this.options = t), this.handleScreenResize();
    }
    get scrollY() {
...
var u = {
  ...
  S = class extends HTMLElement {
    constructor(e = u) {
      ...
      let r = m(u, e),
        t = (e == null ? void 0 : e.scrollTriggerElement)
          ? e.scrollTriggerElement
          : this;
      (this.screenManager = g.instance),
        (this.scrollManager = r.scrollManagement
          ? new b(t, r == null ? void 0 : r.scrollOption)
          : null),
        (this.resizeObserver = e.elementResizeManagement
          ? new ResizeObserver(this._handleResize)
          : null),
        (this.intersectionObserver = r.intersectionObserver
