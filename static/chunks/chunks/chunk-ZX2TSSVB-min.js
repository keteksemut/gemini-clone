...
var c = ({ row: t, isLast: r }) => {
    ...
    return e(
      ...
      e(
        "th",
        {
          className: `gtr-cell gtr-group-title ${
            (t == null ? void 0 : t.groupTitle) ? "gtr-show" : ""
          }`,
        },
        e(
          "div",
          { className: "gtr-col" },
          (t == null ? void 0 : t.groupTitle) || ""
        )
      ),
      e(
        "td",
        {
          className: `gtr-mobile-spacer ${
            (t == null ? void 0 : t.groupTitle) ? "gtr-show" : ""
          }`,
        },
        e("div", { className: "gtr-mobile-bg" })
      ),
      e("td", {
        className: `gtr-mobile-spacer ${
          (t == null ? void 0 : t.groupTitle) ? "gtr-show" : ""
      ...
      e(
        "td",
        { className: "gtr-cell gtr-header", scope: "row" },
        e(
          "div",
          { className: "gtr-col" },
          t.title,
          ...
          a
            ? e(
                ...
                e(
                  "span",
                  {
                    className: `gtr-value js-animate ${
                      a.highlight ||
                      (typeof a.highlight == "undefined" &&
            ...
            ? e(
                ...
                e(
                  "span",
                  {
                    className: `gtr-value js-animate ${
                      l.highlight ||
                      (typeof l.highlight == "undefined" &&
                        l.value > (a == null ? void 0 : a.value))
                        ? "gtr-highlight"
                        : ""
                    }`,
                    "data-no-percent": a.noPercent ? "true" : "false",
                ...
                e(
                  ...
                  {
                    className: "gtr-caption",
                    dangerouslySetInnerHTML: { __html: l.caption },
                  },
                  l.caption
                )
              )
